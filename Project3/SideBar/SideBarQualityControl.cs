...
{
    public partial class SideBarQualityControl : Form
    {
        private String userAccess;
        private String username;
        public SideBarQualityControl(String userAccess, String username)
        {
            InitializeComponent();
            ...
            ShowFormInPanel(new DashboardQC(getUserAccess()));
        ...
        private void switchButtonColor()
        {
            switch (isFormActive)
            {
                case "Dashboard":
                    ...
                    SetButtonInactive(btnStokKeluar, Properties.Resources.small_stokkeluar_white_icon);
                    lblTitle.Text = isFormActive;
                    iconTitle.Image = Properties.Resources.big_home_green_icon;
                    break;

                case "Stok Keluar":
                    SetButtonActive(btnStokKeluar, Properties.Resources.small_stokkeluar_green_icon);
                    SetButtonInactive(btnDashboard, Properties.Resources.small_home_white_icon);
                    lblTitle.Text = isFormActive;
                    iconTitle.Image = Properties.Resources.big_stokkeluar_green_icon;
                    break;
            }
        ...
        private void btnStokKeluar_Click(object sender, EventArgs e)
        {
            ShowFormInPanel(new FormStockKeluar(userAccess));
            isFormActive = "Stok Keluar";
            switchButtonColor();
        }
